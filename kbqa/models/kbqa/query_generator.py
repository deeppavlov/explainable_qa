...
from models.kbqa.query_generator_base import QueryGeneratorBase
from models.kbqa.rel_ranking_infer import RelRankerInfer
from models.kbqa.utils import extract_year, extract_number, order_of_answers_sorting, make_combs, \
    fill_query, find_query_features, make_sparql_query, merge_sparql_query
from models.kbqa.wiki_parser import WikiParser
